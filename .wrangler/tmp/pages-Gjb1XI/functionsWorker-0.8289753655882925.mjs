...
var requireAuth = /* @__PURE__ */ __name((request, env) => {
...
var groupRecords = /* @__PURE__ */ __name((rows) => {
...
var getKeyFromUrl = /* @__PURE__ */ __name((url, publicBase) => {
...
async function onRequest({ request, env }) {
  ...
  if (request.method === "DELETE") {
    ...
    await env.RECORDS_DB.prepare("DELETE FROM records WHERE id = ?1").bind(id).run();
    return jsonResponse({ ok: true });
  }
...
// ../.wrangler/tmp/pages-Gjb1XI/functionsRoutes-0.21478278315219002.mjs
var routes = [
  {
...
// C:/Users/Eternal/AppData/Roaming/npm/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/Eternal/AppData/Roaming/npm/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// C:/Users/Eternal/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// C:/Users/Eternal/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-6nrklW/middleware-insertion-facade.js
...
// C:/Users/Eternal/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-6nrklW/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8289753655882925.mjs.map
